...
# Ask the user to Input a positive integer and output tell is user whether or not the number is a prime number.


# y is asking the user to input a postive integer number
